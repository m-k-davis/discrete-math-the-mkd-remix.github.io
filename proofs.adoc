...
_This chapter was last updated on February 24, 2025_ + 
...
Consider the following proposition: "For all natural number $n,$ the value of $n^{2} + n + 41$ is a prime integer."

For each of the natural numbers 0, 1, ..., 10, the predicate $P(n)$: "$n^{2} + n + 41$ is a prime integer." evaluates to a proposition that is True. In fact, $P(n)$ is True for each of the natural numbers $n$ that is less than or equal to 40. 

It may seem that we have "checked enough cases" to conclude that $P(n)$ will evaluate to a proposition that is True for every possible natural number value of $n.$ However, $P(41)$ is proposition $41^{2} + 41 + 41 \text{is a prime integer.},$ which is False - notice that $41^{2} + 41 + 41 = 41 \cdot (41 + 1 + 1) = 41 \cdot 43$ is a composite number.
