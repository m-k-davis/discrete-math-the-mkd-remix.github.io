...
_This chapter was last updated on January 30, 2025._ + 
...
Click https://en.wikipedia.org/wiki/Pigeonhole_principle#/media/File:TooManyPigeons.jpg[here, window=_blank] to see a commonly-used _photoshopped_ image that illustrates this principle.
...
\text{1} & \text{ if } n \text{ is odd} \\
\text{0} & \text{ if } n \text{ is even} \\
