...
The notation $C(n,r)$ represents the number of combinations of $n$ elements taken $r$ at a time. Note that $_nC_r$ is another commonly-used notation for this count. Either of these notations can read as "$n$ choose $r.$"
****
