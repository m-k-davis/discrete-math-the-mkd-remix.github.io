...
_Operators and Expressions_ in the chapter "Appendix 0: An Introduction to Python".
...
To ensure that we can properly interpret a compund proposition involving multiple logical operations, we can either use parentheses or rely on _operator precedence_. 

To evaluate a compound proposition, we start by evaluating 

* all expressions enclosed in parentheses from left to right, then all negations from left to right, then 
