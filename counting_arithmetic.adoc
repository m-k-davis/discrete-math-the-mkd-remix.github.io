...
_This chapter was last updated on September 3, 2024_ + 
...
This rule is used when there are $n$ ways to complete a procedure, but for each of those ways is equivalent to $d$ ways (including the way itself.)
