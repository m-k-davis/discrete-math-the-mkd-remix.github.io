...
_This chapter was last updated on March 2, 2026_ + 
_inserted Python code for a “proof by cases” example_ + 
_inserted “proof by picture” just or fun! + 
//// 
...
(2) use “proof by cases” thinking to create different test cases for the values assigned to the three variables $a,$ $b,$ and $c,$ then evaluate the function at those test cases to try to validate that the function work as its name indicates.
