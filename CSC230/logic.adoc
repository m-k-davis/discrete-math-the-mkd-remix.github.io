...
////
You can write logically equivalent expressions for $S$ and $C_{out}$ by first writing expressions in Disjucntive Normal Form and then simplify those expressions using some of the other logical equivalences listed earlier in the chapter: 
