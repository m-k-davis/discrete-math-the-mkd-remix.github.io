...
_This chapter was last updated on January 25, 2025._ + 
...
[horizontal]
Handshake Lemma (DMP Lesson 3):: This lesson can be used to introduce the concept of conjecture, lay the groundwork for proof, and provide a nonarithmetic/nonalgebraic example for proof by mathematical induction that can be referred to later when mathematical induction is formally introduced. + 
