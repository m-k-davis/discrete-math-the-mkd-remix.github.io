...
// MKD Feb 9 2026 Converting to bin/oct/hex in Python
//https://pythontutor.com/visualize.html#code=print%28bin%2813%29%29%0Aprint%28oct%2813%29%29%0Aprint%28hex%2813%29%29&cumulative=false&curInstr=3&heapPrimitives=nevernest&mode=display&origin=opt-frontend.js&py=3&rawInputLstJSON=%5B%5D&textReferences=false
...
// MKD Jan 19 2026 inserted Mayan, but most browsers do not render it
//* the ancient Mayan "𝋥". 
// * the Maya "_". 
// "_" is Low Line U+005F, not the correct symbol 01D2E5
//[small]#NOTE: The ancient Mayan character should look like a horizontal bar, but will only display correctly if a font supporting the Mayan numerals is installed on your device.#
...
// MKD Jan 29 2026 
[small]#Note: The Maya numeral may not display correctly in some browsers; it should appear as a link:https://commons.wikimedia.org/wiki/File:Maya_5.svg[horizontal bar.]#
...
[small]#NOTE: The reason we use base-ten numerals as the subscripts on numerals in other bases is because base-ten is so dominant: It is the "privileged" base, so we need to indicate when a different base is being used... and we don't need to use the parentheses or subscripts if we are already working in base-ten.#
...
// MKD Jan 28 2026 code to print int as binary string 
// https://pythontutor.com/render.html#code=def%20binaryExpansion%28n%3A%20int%29%3A%0A%20%20%20%20%23print%28bin%28n%29%29%0A%20%20%20%20return%20str%28bin%28n%29%29%0A%20%20%20%20%0A%23binaryExpansion%28100%29%0Aprint%28binaryExpansion%28100%29%29&cumulative=false&curInstr=0&heapPrimitives=nevernest&mode=display&origin=opt-frontend.js&py=311&rawInputLstJSON=%5B%5D&textReferences=false
...
// MKD Jan 29 2026 wording revised
We can summarize what the algorithm does as a *mathematical theorem,* though technically at this point, it's only a *conjecture,* an educated guess based on a few cases that seem to indicate that the algorithm will always work. You will learn a technique that 
//will 
you can use to 
prove the theorem by validating the algorithm for _all_ choices of natural numbers $n$ and $b>1$ in the link:./induction.html[Proofs: Mathematical Induction ] chapter.
...
// MKD Jan 29 2026 
That is, for each positive integer $b > 1,$ every positive integer $n$ has a unique base-$b$ expansion. 
